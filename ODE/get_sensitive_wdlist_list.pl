...
use utf8;
use strict;
our ($LOG, $LOAD, $opt_f, $opt_u, $opt_D, $opt_I, $opt_O, @SCLASSES, @SINFO, %COL);
if (0)
{
...
@SCLASSES =    ("derogatory", "vulgar", "offensive", "age", "crime", "disability", "ethnicity", "gendered", "geography", "other", "politics", "religion", "sex", "socioeconomic", "substance", "suicide", "trademark");
