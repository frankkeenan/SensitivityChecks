...
#	unless (m|<entry|){print $_; next line;}
	...
	$_ = restructure::rename_tag_in_tag($_, "exg", "lev", "label_exg");
	$_ = restructure::rename_tag_in_tag($_, "semb", "lev", "label_semb");
#	$_ = restructure::rename_tag_in_tag($_, "gramb", "lev", "label_gramb");
	$_ = restructure::rename_tag_in_tag($_, "frmg", "lev", "label_frmg");
